...
namespace MaxiTour
{
    public class Administratif : Employe
    {
        ...
        public Administratif( int id, string nom, string prenom, int numsecu, string adresse, int codepostal, string ville, int telephone, string email, DateTime dateEmbauche, string typeContrat, double salaire, double nbrHeures, Poste poste)
